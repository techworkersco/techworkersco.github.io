...
First, some news from us: [**we're announcing an open call for submissions**]({% link call-for-submissions.md %}).

As tech workers organize and build power in the industry, we invite you to share your workers' perspectives &mdash; even if it's just an idea. We also welcome suggestions for tech labor news, historical events to highlight, song recommendations, and other contributions. Read more [here]({% link call-for-submissions.md %})!
